...
export const reverseSentences: ReverseSentence[] = [
  ...
  // Work / tourist service (more)
  {
    id: "r-s7",
    english: "Do you have a reservation?",
    thaiPhonetic: "ดู-ยู-แฮฟ-อะ-เรส-เซอร์-เว-ชั่น",
    meaning: "คุณมีการจองไหม",
    category: "service",
    emoji: "📓",
  },
  {
    ...
    thaiPhonetic: "ฮาว-เม-นี่-พี-เพิล",
    meaning: "กี่ท่าน",
    category: "service",
    emoji: "👥",
  },
  {
    ...
    thaiPhonetic: "อิส-เอฟ-รี่-ทิง-โอ-เค",
    meaning: "ทุกอย่างเรียบร้อยไหม",
    category: "service",
    emoji: "🙂",
  },
  {
    ...
    thaiPhonetic: "ซี-ยู-อะ-เกน",
    meaning: "แล้วเจอกันใหม่",
    category: "service",
    emoji: "👋",
  },
];
